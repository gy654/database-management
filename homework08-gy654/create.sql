...
-- COPY (id, name, sex, age, height, weight, team, noc, games, year, season, city, sport, event, medal) from '/Users/yge/Documents/2022Fall/data_management_and_analysis/athlete_events.csv' csv header null as 'NA'
-- COPY noc_region from '/Users/yge/Documents/2022Fall/data_management_and_analysis/noc_regions.csv' csv header null as 'NA';